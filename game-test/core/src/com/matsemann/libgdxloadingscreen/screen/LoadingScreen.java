...
public class LoadingScreen extends AbstractScreen {
    ...
    public void show() {
        ...
        game.manager.load(Res.Atlas.ATLAS_PATH, TextureAtlas.class);
        ...
        //获取地图集
        TextureAtlas atlas2 = game.manager.get(Res.Atlas.ATLAS_PATH, TextureAtlas.class);
        ...
        Array<TextureAtlas.AtlasRegion> regions = atlas2.findRegions(Res.Atlas.IMAGE_BIRD_YELLOW_01_TO_03);

        // Add the loading bar animation
        Animation anim = new Animation(0.05f, atlas.findRegions("loading-bar-anim") );
// Add the loading bar animation
        Animation fly = new Animation(0.2f, regions);
        anim.setPlayMode(Animation.PlayMode.LOOP_REVERSED);
        fly.setPlayMode(Animation.PlayMode.LOOP);
        loadingBar = new LoadingBar(anim);
        person = new Person(fly);
...
//        stage.setViewport(width , height, false);
    ...
    public void render(float delta) {
        ...
        person.setX(startX + endX * percent);
